...
getPlaylistPairsByListName = async (req, res) => {
    console.log("getPlaylistPairsByListName");
                ...
                if (!playlists) {
                    ...
                    for (let key in playlists) {
                        ...
                        if(req.params.term !== "null"){
                            if(pair.name.includes(req.params.term)){
                                pairs.push(pair);
                            }
                        } else {
                            pairs.push(pair);
...
getPlaylistPairsByUsername = async (req, res) => {
    console.log("getPlaylistPairsByUsername");
        async function asyncFindList() {
            console.log("find all published playlists");
            await Playlist.find({ published: true }, (err, playlists) => {
                console.log("found Playlists: " + JSON.stringify(playlists));
                ...
                if (!playlists) {
                    ...
                    for (let key in playlists) {
                        ...
                        console.log(req.params.term);
                        if(req.params.term !== "null"){
                            if(pair.ownerUsername.includes(req.params.term)){
                                pairs.push(pair);
                            }
                        } else {
                            pairs.push(pair);
